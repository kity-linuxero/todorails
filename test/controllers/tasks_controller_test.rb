...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task" do
    assert_difference('Task.count') do
      post tasks_url, params: { task: { description: @task.description, end_at: @task.end_at, percentage_of_completion: @task.percentage_of_completion, priority: @task.priority, start_at: @task.start_at, status: @task.status, task_list_id: @task.task_list_id, type: @task.type } }
    end
